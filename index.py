...
def procesar_archivo(archivo_cargado, plantilla):
    ...
    # Ahora proceder con la conversión a CSV
    return output
...
if archivo_cargado is not None:
    ...
    if output:
        # Usamos el archivo procesado y lo pasamos a la función de copia a plantilla para generar CSV
        file_o = copy_data_to_template(pd.read_excel(output), "O", selected_name="nombre1", template_file=plantilla_path)
